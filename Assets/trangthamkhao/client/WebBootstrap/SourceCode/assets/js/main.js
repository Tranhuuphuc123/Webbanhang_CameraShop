...
// =====================
// SECTION 3 CỦA INDEX: FLASH SALE TABS UI - homepage
// =====================
document.addEventListener("DOMContentLoaded", function () {
  ...
  tabBtns.forEach((btn) => {
    btn.addEventListener("mouseenter", function () {
      ...
      if (tabContent)
        tabContent.classList.add("pv-flashsale-tab-content-hovered");
    });
    btn.addEventListener("mouseleave", function () {
      btn.classList.remove("hovered");
      if (tabContent)
        tabContent.classList.remove("pv-flashsale-tab-content-hovered");
    });
...
/**************************************************************************************************** */
/**>>>phần script của page product details<<< */
// =====================
